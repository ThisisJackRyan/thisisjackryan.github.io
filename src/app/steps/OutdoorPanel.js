...
function OutdoorPanel() {
    return (
        <div id='outdoor' className='h-dvh'>
            <div className='flex justify-center border-t mx-16'>
                <div className='flex-1/2 my-12 flex justify-center items-center'>
                    <Image src='/outdoors.png' width={500} height={300} className='rounded-lg' alt="outdoor representation"/>
                </div>
                <div className='flex-1/2 my-12 p-4 ml-12 pl-8 border-l'>
                    ...
                    <br />
                    <p className='text-xl'>While life often gets in the way of my life outdoors, I have so many adventures to live. Now, I'm finally starting to learn how to prioritize them and plan on sharing them with </p>
